...
import com.vivian.World.Banking.App.payload.request.*;
...
public class UserServiceImpl implements UserService {
    ...
    public BankResponse creditAccount(CreditAndDebitRequest request) {
        ...
        // to create an account, first check if the account exists
    ...
    public BankResponse transfer(TransferRequest request) {
        ...
        UserEntity destinationAccountUser = userRepository.findByAccountNumber(request.getSourceAccountNumber());
